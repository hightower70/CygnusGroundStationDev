...
namespace CygnusControls
{
	...
	public class ModuleManager
	{
		...
		private ModuleBase m_main_module = null;
		...
		public void AddMainModule(ModuleBase in_main_module)
		{
			m_main_module = in_main_module;
		}
		...
		public bool ModulesLoad()
		{
			...
			m_modules.Clear();
			if (m_main_module != null)
				m_modules.Add(m_main_module);
