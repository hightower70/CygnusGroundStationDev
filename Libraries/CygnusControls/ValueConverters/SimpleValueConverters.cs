...
namespace CygnusControls
{
  ...
  public class IsRegexMatchConverter : IValueConverter
  {
	...
	/// <summary>
	/// FloatToDoubleValueConverter provides a two-way conversion between
	/// a double value and an integer.
	/// </summary>
	[ValueConversion(typeof(double), typeof(int))]
	public class FloatToDoubleValueConverter : IValueConverter
	{
		#region Converter function
		public object Convert(object value, Type targetType, object parameter, System.Globalization.CultureInfo culture)
		{
		...
		/// Singleton storage
		/// </summary>
		private static FloatToDoubleValueConverter m_instance = new FloatToDoubleValueConverter();

		/// <summary> 
		/// The TriggerComparer instance 
		/// </summary> 
		public static FloatToDoubleValueConverter Instance
		{
			get
			{
				return m_instance;
		...
		private object GeneralConvert(object in_value, Type in_target_type)
		{
			if (in_target_type == typeof(int))
			{
				if (in_value == null)
					...
					return System.Convert.ToSingle(in_value);
			}
			else
			{
				if (in_value == null)
	...
	/// </summary>
	[TypeConverter(typeof(DecimalToFloatConverter))]
	[ValueConversion(typeof(decimal), typeof(float))]
	public class DecimalToFloatConverter : IValueConverter
	{
		...
		public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
		{
			if ((targetType != typeof(Decimal)) || (value.GetType() != typeof(Single)) )
			{
				//throw new InvalidOperationException("Value must be decimal type and target must be of type float");
			}
		...
		/// Singleton storage
		/// </summary>
		private static DecimalToFloatConverter m_instance = new DecimalToFloatConverter();

		/// <summary> 
		/// The default instance 
		/// </summary> 
		public static DecimalToFloatConverter Instance
		{
			get
			{
				return m_instance;
		...
		public object ConvertBack(object value, Type targetType, object parameter, CultureInfo culture)
		{
			if ((targetType != typeof(Single)) || (value.GetType() != typeof(Decimal)))
			{
				//throw new InvalidOperationException("Value must be decimal type and target must be of type float");
			}
