...
namespace CygnusGroundStation
{
	public class FormManager
	{
		...
		#region · Realtime object provider refresh ·

		public void ObjectRefreshRegisterProvider(IRealtimeObjectRefresher in_provider )
		{
		...
		public void ObjectRefreshDeregisterProvider(IRealtimeObjectRefresher in_provider)
		{
			lock(m_object_refreshers)
			{
