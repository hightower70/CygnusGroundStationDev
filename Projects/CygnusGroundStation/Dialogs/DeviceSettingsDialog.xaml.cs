...
namespace CygnusGroundStation.Dialogs
{
	...
	public partial class DeviceSettingsDialog : Window, INotifyPropertyChanged
	{
		...
		{
			CommunicationManager.Default.FileTransfer.FileUploadStart(m_files_info[1].FileID, (uint)in_value_info.BinaryOffset, in_value_info.GetBinaryData(), null);
		}
		...
		private void bErrorOkButton_Click(object sender, RoutedEventArgs e)
		{
			m_dialog_result = true;
			this.DialogResult = m_dialog_result;
		}
