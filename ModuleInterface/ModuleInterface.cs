	...
	public class ModuleInterface : ModuleBase
	{
		...
		public override ModuleSettingsInfo[] GetSettingsInfo()
		{
			return m_module_settings_info;
									 ...
									 /*
		public override string[] GetSettingPageList()
		{
			return new string[] { "General", "Forms", "About" };
		}

		public override FrameworkElement GetSettingsPage(int in_index)
		{
			switch (in_index)
			{
				case 0:
					return new SetupGeneral();

				case 1:
					return new SetupForms();
